...
parse_subject_sample_map = parse_timecourse_data.parse_subject_sample_map 
...
#
###############################################################################
def calculate_ordered_nonconsecutive_subject_pairs(sample_order_map, sample_list=[]):
