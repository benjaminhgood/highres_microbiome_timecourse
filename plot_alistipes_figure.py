...
parser.add_argument('--output-filename', type=str, help='Store colored snps', default='alistipes_figure_snps.txt')
...
abundance_axis.set_ylim([3e-04,3e-01])
...
filename = parse_midas_data.analysis_directory+('alistipes_figure.png')
