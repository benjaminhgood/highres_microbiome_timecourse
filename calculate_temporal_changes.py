...
if __name__=='__main__':
    ...
    subject_sample_map = parse_sample_data.parse_subject_sample_map()
    sample_order_map = parse_sample_data.parse_sample_order_map()
    ...
    for species_name in good_species_list:
        ...
        snp_samples = list(set(snp_samples) & set(parse_sample_data.highcoverage_samples))
    
        same_sample_idxs, same_subject_idxs, diff_subject_idxs = parse_midas_data.calculate_ordered_nonconsecutive_subject_pairs(sample_order_map, snp_samples)
        ...
        same_sample_idxs, same_subject_idxs, diff_subject_idxs = parse_midas_data.calculate_ordered_nonconsecutive_subject_pairs(sample_order_map, gene_samples)
