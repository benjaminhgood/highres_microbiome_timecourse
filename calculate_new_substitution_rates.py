...
intermediate_filename = '%snew_substitution_rates.txt' % (parse_midas_data.data_directory)
...
if __name__=='__main__':
    ...
    for species_name in good_species_list:
        ...
        snp_samples = diversity_utils.calculate_highcoverage_samples(species_name)
        ...
        while final_line_number >= 0:
            ...
            # All pi
            chunk_snp_pi_difference_matrix, chunk_snp_pi_opportunity_matrix = diversity_utils.calculate_pi_matrix(allele_counts_map, passed_sites_map)
