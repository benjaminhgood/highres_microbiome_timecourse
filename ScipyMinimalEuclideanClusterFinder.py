...
for d in distances:
    ...
    nodes = fcluster(Z, d, criterion="distance")
...
d = distances[silhouette_scores.argmax()]
...
print d, len(cluster_As_map.keys())
...
pylab.savefig('euclidean_cluster_example.png',bbox_inches='tight',dpi=300)
sys.exit(0)
